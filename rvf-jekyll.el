(org-export-define-derived-backend 'jekyll 'md
  :translate-alist '(
		     (latex-environment . org-jekyll-latex-environment)
		     (latex-fragment . org-jekyll-latex-fragment)
...
(defun org-jekyll-latex-environment (latex-environment contents info)
  (let* (
...
(defun org-jekyll-latex-fragment (latex-fragment contents info)
  (let* (
...
(defun org-jekyll-export-as-jekyll
